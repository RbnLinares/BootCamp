...
-- INSERT into movies(movie_title, released_date, fk_director_id)
-- VALUES 
...
-- ('Up in the Air', '2009-09-5', (SELECT director_id FROM directors WHERE last_name = 'Reitman')),
-- ('E.T. The Extra-Terrestrial', '1982-09-05', (SELECT director_id FROM directors WHERE last_name = 'Speilberg')),
-- ('Jurasic Park', '1993-09-11', (SELECT director_id FROM directors WHERE last_name = 'Speilberg')),
-- ('Munich', '2005-12-02', (SELECT director_id FROM directors WHERE last_name = 'Speilberg'));
